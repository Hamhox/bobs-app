...
export const VOYAGER_SCREEN_REGISTRY = {
  ...
  map: {
    ...
    variants: {
      map: { view: "primary", tabsVisible: true, sideArrows: true },
      "map1-2": { view: "primary", tabsVisible: false, sideArrows: true },
      map2: { view: "secondary", tabsVisible: false, sideArrows: false, interaction: "pan" },
      "map2-2": { view: "secondary", tabsVisible: false, sideArrows: false, interaction: "pan" },
  ...
  user: {
    ...
    showSideArrows: true,
    variants: {
      cstm: { view: "primary", tabsVisible: true, sideArrows: true },
      "cstm1-2": { view: "primary", tabsVisible: false, sideArrows: true },
      cstm2: { view: "secondary", tabsVisible: true, sideArrows: true },
      "cstm2-2": { view: "secondary", tabsVisible: false, sideArrows: true },
    },
  },
  nav: {
    id: "nav",
