...
export const VOYAGER_SCREEN_REGISTRY = {
  ...
  map: {
    ...
    variants: {
      map: { view: "overview", mapView: "overview", tabsVisible: true, sideArrows: true, screenIndicator: 1 },
      "map1-2": { view: "overview", mapView: "overview", tabsVisible: false, sideArrows: true, screenIndicator: 1 },
      map2: { view: "overview-edit", mapView: "overview", tabsVisible: false, sideArrows: false, editing: true, interaction: "pan" },
      "map2-2": { view: "detail", mapView: "detail", tabsVisible: false, sideArrows: true, screenIndicator: 2 },
      map3: { view: "detail-edit", mapView: "detail", tabsVisible: false, sideArrows: false, editing: true, interaction: "pan" },
      "map3-2": { view: "detail-edit", mapView: "detail", tabsVisible: false, sideArrows: false, editing: true, interaction: "pan" },
    },
  },
  temp: {
    id: "temp",
...
export const VOYAGER_STABLE_STATE_ALIASES = {
  ...
  "gauge.map.overview.edit": "map2",
  "gauge.map.detail.edit": "map3",
